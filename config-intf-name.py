...
def pre_check(interface):
    ...
    try:
        if response['ifname'] == interface['logical_name']:
            return ("exist")
    except:
        return
